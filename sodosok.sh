...
wget -O cek-ss "https://raw.githubusercontent.com/gilagajet/premvps/main/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/gilagajet/premvps/main/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
